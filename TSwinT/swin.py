...
class SwinTransformerBlock(tf.keras.layers.Layer):
    ...
    def get_config(self):
        return {'dim': self.dim, 'input_resolution': self.input_resolution, 'num_heads': self.num_heads, 'window_size': self.window_size, 'shift_size': self.shift_size, 'mlp_ratio': self.mlp_ratio} 
...
class PatchMerging(tf.keras.layers.Layer):
    ...
    def get_config(self):
        return {'input_resolution': self.input_resolution, 'dim': self.dim }
...
class BasicLayer(tf.keras.layers.Layer):
    ...
    def get_config(self):
        return {'dim': self.dim, 'input_resolution': self.input_resolution, 'depth': self.depth, 'use_checkpoint': self.use_checkpoint }
...
class PatchEmbed(tf.keras.layers.Layer):
    ...
    def get_config(self):
        return {'img_size': self.img_size, 'patch_size': self.patch_size, 'patches_resolution': self.patches_resolution, 'num_patches': self.num_patches, 'in_chans': self.in_chans, 'embed_dim': self.embed_dim }
...
class SwinTransformerModel(tf.keras.Model):
    ...
    def get_config(self):
        return {'num_classes': self.num_classes, 'num_layers': self.num_layers, 'embed_dim': self.embed_dim, 'ape': self.ape, 'patch_norm': self.patch_norm, 'num_features': self.num_features, 'mlp_ratio': self.mlp_ratio }
